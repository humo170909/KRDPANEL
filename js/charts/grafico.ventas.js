...
import { fmt, mostrarToast, sanitize } from "../utils/helpers.js";
  ...
  contenedor.innerHTML = `
    ...
    <div style="display:flex;gap:16px;margin-top:12px;flex-wrap:wrap">
      <span style="display:flex;align-items:center;gap:6px;font-size:11px;color:#8b949e;font-family:monospace">
        <span style="width:10px;height:10px;border-radius:2px;background:#58a6ff;display:inline-block"></span>${sanitize(mesActual?.nombre||"Este mes")}
      </span>
      ${datosAnterior.length ? `<span style="display:flex;align-items:center;gap:6px;font-size:11px;color:#8b949e;font-family:monospace"><span style="width:14px;height:0;border-top:1.5px dashed #8b949e;display:inline-block"></span>${sanitize(mesAnterior?.nombre||"Mes anterior")}</span>` : ""}
